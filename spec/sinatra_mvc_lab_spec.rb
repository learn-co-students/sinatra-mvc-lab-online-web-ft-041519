describe "Pig Latinizer App" do
  ...
  describe "POST '/piglatinize' again" do
    ...
    it "displays the pig latinized phrase upon form submission" do
      expect(last_response.body).to include("He asway anway oldway anmay owhay ishedfay aloneway inway away iffskay inway ethay Gulf Stream andway ehay adhay onegay eightyway ourfay aysday ownay ithoutway akingtay away ishfay")
    end
  end
